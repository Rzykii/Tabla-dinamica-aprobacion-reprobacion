Actividad autónoma: Tabla dinámica de aprobación y reprobación
...
La columna Estado debe determinar automáticamente si el estudiante se encuentra Aprobado o Reprobado, de acuerdo con la nota ingresada:

Si la nota es mayor o igual a 4, el estado será “Aprobado”.
Si la nota es menor que 4, el estado será “Reprobado”.

Además, el texto del estado deberá cambiar de color según corresponda:
